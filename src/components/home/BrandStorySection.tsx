...
export default function BrandStorySection() {
    return (
        <section id="brand-story" className="bg-brand-black">
            {/* Header */}
            <div className="relative py-24 bg-brand-black overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-4 text-center">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-brand-white mt-2">브랜드 스토리</h2>
            ...
            {/* Section 2: Duroc */}
            <div className="py-20 bg-brand-gray/10">
                <div className="container mx-auto px-4">
