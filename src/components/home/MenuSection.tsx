...
export default function MenuSection() {
    return (
        <section id="menu" className="bg-brand-black pb-20">
            {/* Header */}
            <div className="relative py-20 bg-brand-gray/20">
                <div className="container mx-auto px-4 text-center">
                    <span className="text-brand-gold font-bold tracking-widest text-sm uppercase">MENU</span>
                    <h2 className="text-4xl md:text-5xl font-bold text-brand-white mb-4 mt-2">전체 메뉴</h2>
                    ...
                    return (
                        <div key={category.id} className="scroll-mt-24">
                            <div className="mb-8 border-l-4 border-brand-gold pl-4">
                                <h3 className="text-2xl md:text-3xl font-bold text-brand-white">{category.name}</h3>
                                    ...
                                    <div key={item.id} className="bg-brand-gray rounded-lg overflow-hidden group hover:ring-1 hover:ring-brand-gold transition-all duration-300">
                                        ...
                                        <div className="p-5">
                                            <div className="flex justify-between items-start mb-2">
                                                <h4 className="text-xl font-bold text-brand-white">{item.name}</h4>
